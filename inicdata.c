...
typedef struct http_data_t
{
		...
		bool login;
		bool login_done;
		bool there_is_data;//http鍖呬腑绾暟鎹儴鍒嗗簲璇ヤ粠\r\n\r\n涔嬪悗寮�濮嬶紝鑻ヨ鏁版嵁鍖呬腑鍚?\r\n\r\n锛屽苟涓斾箣鍚庢湁鏁版嵁锛屽垯there_is_data = true,骞惰涓嬫暟鎹捣濮嬩綅缃?
		bool get_content;
		bool put_content;
		bool get_done;
		bool put_done;
		bool head_first;
		bool get_first;
		uint32_t  pos;//鎸囧悜闇�瑕佸姞瑙ｅ瘑鐨勬暟鎹殑璧峰浣嶇疆 
		uint8_t username[128];// Authorization锛?AWS username:XXX   2 
