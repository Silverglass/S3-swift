...
COMPILE += -Wall -Wa,-a=$@.list -Wno-unused-parameter -O2 -g -fno-strict-aliasing $(DEBUG_FLAGS) $(CORE_MASKS) $(CC_FLAGS) -I$(OCTEON_ROOT)/components/crypto-api/core/include
...
ECHO_SERVER   = $(OBJ_DIR)/app-echo-server.o $(OBJ_DIR)/app-echo-server-cb.o $(OBJ_DIR)/app-server-raw.o
CLIENT_APP    = $(OBJ_DIR)/app-client.o $(OBJ_DIR)/app-client-cb.o
...
CFLAGS_LOCAL = -g -O2 -W -Wall -Wno-unused-parameter -I$(CLI_APP_INCLUDE) -I$(OCTEON_ROOT)/target/include $(CFLAGS_CRYPTO) 
